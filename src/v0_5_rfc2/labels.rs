//! "labels" metadata.
//!
//! <https://ngff--242.org.readthedocs.build/latest/index.html#labels-md>.
...
"#;
        ...
        let labels = ome_metadata.get("labels").unwrap();
        let _labels: Labels = serde_json::from_value(labels.clone()).unwrap();
    }

    #[test]
    fn image_label_0_5_rfc2_spec() {
        let json = r#"
{
  "zarr_format": 3,
  "node_type": "group",
...
"#;
    ...
    #[test]
    fn image_label_0_5_rfc2_minimal() {
        let json = r#"
{
  "zarr_format": 3,
  "node_type": "group",
